...
export default function SecurityMonitoringServicesLocationPage({ params }: ServiceLocationPageProps) {
  ...
  const service = {
    ...
    shortDescription: `Protect your ${locationName} business website from threats and ensure it runs smoothly with our comprehensive security and monitoring services.`,
    description: `Our Security & Monitoring Services provide comprehensive protection and proactive maintenance for ${locationName} business websites. We implement robust security measures to protect against hackers, malware, and data breaches, while our ongoing monitoring ensures your website remains fast, functional, and up-to-date. From regular backups and software updates to security scans and performance monitoring, our service gives ${locationName} businesses peace of mind that their online presence is secure and continuously operating at its best. We handle the technical aspects of website maintenance so you can focus on running your business in ${locationName}.`,
      ...
      <Section className="bg-white">
        <Container>
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold mb-6 text-center">About Our {service.title} in {locationName}</h2>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">Protect your {locationName} business reputation with a secure website</span>
                </li>
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-secondary-800 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="text-gray-700">Prevent downtime that could cost your {locationName} business customers</span>
                </li>
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-secondary-800 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="text-gray-700">Safeguard customer data and maintain trust with {locationName} customers</span>
                </li>
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-secondary-800 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="text-gray-700">Get dedicated support from a local {locationName} web team</span>
                </li>
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-secondary-800 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="text-gray-700">Focus on growing your {locationName} business, not website maintenance</span>
                </li>
              </ul>
            </div>
            <div className="relative h-[300px] md:h-[400px] rounded-lg overflow-hidden shadow-xl">
      ...
      <Section className="bg-white">
        <Container>
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto text-center mb-12">
            We provide {service.title} to businesses throughout Hertfordshire. Explore our services in other locations.
          </p>
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">
              Ready to Keep Your {locationName} Business Website Secure?
            </h2>
            <p className="text-lg text-gray-200 mb-8">
              Contact us today to discuss how our {service.title} can help protect your {locationName} online presence and give you peace of mind.
            </p>
