...
export default function PerformanceSpeedOptimizationPage() {
  const service = {
    title: 'Performance & Speed Optimization',
    ...
    description: 'Our Performance & Speed Optimization service is designed to make your website lightning-fast and responsive across all devices. Website speed is a critical factor in both user experience and search engine rankings. We conduct thorough performance audits, identify bottlenecks, and implement proven optimization techniques to significantly reduce loading times. From image optimization and code minification to server-side improvements and caching strategies, our comprehensive approach ensures your website performs at its best, keeping visitors engaged and improving your conversion rates.',
    ...
    faqs: [
      {
        ...
        answer: 'Most websites we optimize see loading time improvements of 40-70%, though results vary based on your current setup, hosting environment, and the complexity of your website. We provide before and after metrics so you can see the exact improvements made.'
      },
      {
        question: 'Will the optimization affect how my website looks or functions?',
        answer: 'No, our optimization process preserves all the visual elements and functionality of your website. We focus on the technical aspects that affect performance without changing your design or features. In fact, a faster website often makes features seem more responsive.'
      },
      {
        question: 'How long does the speed optimization process take?',
        answer: 'For most websites, we can complete the optimization process within 3-5 business days. More complex websites or those with significant performance issues may take longer. We will provide you with a specific timeline after our initial audit.'
      },
      {
        question: 'Do I need to change my hosting provider for better performance?',
        answer: 'Not necessarily. While hosting quality does impact performance, our optimization techniques can significantly improve speed on most hosting platforms. If we determine that your hosting is severely limiting your site performance, we will recommend alternatives, but this is relatively rare.'
      },
      {
        question: 'Will you continue to monitor my website performance after optimization?',
        answer: 'Our standard service includes a follow-up performance check one month after completion. For ongoing monitoring and optimization, we offer a maintenance package that ensures your website continues to perform at optimal levels as new content is added and technologies evolve.'
      }
    ]
  };
