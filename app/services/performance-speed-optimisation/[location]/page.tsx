...
export async function generateMetadata({ params }: ServiceLocationPageProps): Promise<Metadata> {
  // Format the location name for display (replace hyphens with spaces and capitalize first letter of each word)
  ...
  return {
    title: `Performance & Speed Optimisation in ${locationName} | Hertfordshire Websites`,
    description: `Professional website performance and speed optimisation services for ${locationName} businesses. Enhance your user experience and SEO with a faster website.`,
    openGraph: {
      title: `Performance & Speed Optimisation in ${locationName} | Hertfordshire Websites`,
      description: `Professional website performance and speed optimisation services for ${locationName} businesses. Enhance your user experience and SEO with a faster website.`,
      locale: 'en_GB',
      ...
      images: [
        {
          url: '/images/example-work-place.jpg',
          width: 1200,
          height: 630,
          alt: `Performance & Speed Optimisation Services in ${locationName}`,
        }
      ],
    },
    twitter: {
    ...
    keywords: `website speed optimisation ${locationName}, performance optimisation ${locationName}, website speed, page speed improvements ${locationName}, faster loading website ${locationName}, performance enhancement, Core Web Vitals, SEO speed optimisation ${locationName}`,
  };
}

export default function PerformanceSpeedOptimisationLocationPage({ params }: ServiceLocationPageProps) {
  ...
  const service = {
    ...
    description: `Our Performance & Speed Optimisation service for ${locationName} businesses is designed to make your website lightning-fast and responsive across all devices. Website speed is a critical factor in both user experience and search engine rankings. We conduct thorough performance audits, identify bottlenecks, and implement proven optimisation techniques to significantly reduce loading times. From image optimisation and code minification to server-side improvements and caching strategies, our comprehensive approach ensures your ${locationName} business website performs at its best, keeping visitors engaged and improving your conversion rates.`,
