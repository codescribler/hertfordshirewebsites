...
export function generateMetadata({ params }: ServiceLocationPageProps): Metadata {
  ...
  return {
    title: `Google Analytics & Search Console Setup in ${locationName} | Hertfordshire Websites`,
    description: `Professional Google Analytics and Search Console setup services for ${locationName} businesses. Track your website performance and improve your search visibility.`,
  };
}
