...
const ServicesSection = () => {
  const coreServices = [
    ...
    },
    {
      ...
      description: 'A multi-page business website featuring professional web design, service pages, lead generation features, local SEO elements for Hertfordshire, and blog functionality.',
      benefits: 'Helps established businesses attract more local customers through effective website design in Hertfordshire and convert visitors into qualified leads.',
      idealFor: 'Established local businesses in Hertfordshire looking to grow',
      icon: <WebsiteIcon />,
    ...
    {
      title: 'Herts Growth',
      description: 'A conversion-focused website with advanced SEO optimisation designed for businesses looking to scale. Includes advanced marketing tools, CRM integration, and lead nurturing automation.',
      benefits: 'Leverages expert SEO in Hertfordshire and strategic web design to transform your website into a powerful marketing and sales tool that generates leads automatically.',
      idealFor: 'Growing Hertfordshire businesses ready to scale operations',
      icon: <WebsiteIcon />,
  ...
  const additionalServices = [
    ...
    },
    {
      ...
      description: 'Comprehensive SEO optimisation specifically for Hertfordshire businesses to improve website visibility in local search engines.',
      benefit: 'Rank higher in Google searches for relevant terms with our targeted SEO Hertfordshire services, bringing more local customers to your website.',
      icon: <SeoIcon />,
