...
export function generateMetadata({ params }: ServiceLocationPageProps): Metadata {
  ...
  return {
    title: `Essential Web Design in ${locationName} | Hertfordshire Websites`,
    description: `Professional web design services for ${locationName} small businesses. Get a simple, effective website that helps you get started online.`,
  };
}
